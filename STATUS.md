...
| A-01 | deploy | docker-compose: Neo4j + Ollama (+ healthcheck), инструкция запуска | 📋 | — | — |
...
| A-04 | search | Эмбеддинги bge-m3 для чанков (модуль embeddings, офлайн-батч) | 📋 | — | — |
...
| A-08 | extraction | LLM-извлечение по онтологии (Qwen/Ollama, structured output по схеме ExtractionResult) | 📋 | — | — |
