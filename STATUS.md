...
| A-24 | ui | Редизайн демо (решение PM 04.07 ~19:30): двухколоночный ответ, вкладки левой (источники/RU vs 🌍) и правой (подграф/противоречия/эксперты/рекомендации) колонок, карточки источников с «Открыть документ» (meta.jsonl), чипы «Как система поняла вопрос» (роутер), вкладки карты пробелов, экспорт в шапки | ✅ | оркестратор (Fable) лично; правки PM (эксперты из реко, подвкладки гео-списков), ревью-workflow — 8/10 находок исправлено, pytest 667+3 xfail | worklogs/ui.md |
